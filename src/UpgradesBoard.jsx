    ...
    <div className="upgradePanel">
      ...
      <div className="progressButtons">
        <button 
          ...
          onClick={ () => dispatch({ type: 'BUY_DAMAGE_UPGRADE', cost: 15, step: 0, damage: 2 }) }
        >
        ...
        <button
          ...
          onClick={ () => dispatch({ type: 'BUY_DAMAGE_UPGRADE', cost: 30, step: 1, damage: 5 }) }
        >
          Renos-Lanzamisiles
        ...
        <button 
          ...
          onClick={ () => dispatch({ type: 'BUY_DAMAGE_UPGRADE', cost: 50, step: 2, damage: 10 }) }
        >
